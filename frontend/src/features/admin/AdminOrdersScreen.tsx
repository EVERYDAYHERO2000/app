...
import { Box, Typography, Paper, Chip, CircularProgress, Stack, Tabs, Tab } from '@mui/material';
...
export function AdminOrdersScreen() {
  ...
  const filteredOrders = useMemo(() => {
    ...
    // "Все" = все заказы, которые еще не завершены (не выполнены и не отклонены).
    ...
    <>
      ...
      <Box sx={{ px: 2, pb: 2 }}>
        ...
        >
          ...
          >
            <Tab value={0} label="Все" sx={{ minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis' }} />
            <Tab value={1} label="Новые" sx={{ minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis' }} />
            <Tab value={2} label="В работе" sx={{ minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis' }} />
            <Tab value={3} label="Выполненые" sx={{ minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis' }} />
          </Tabs>
        </Box>
        ...
        {loading ? (
          ...
          <Paper sx={{ p: 3 }}>
            ...
            <Typography color="text.secondary">Пока нет записей в системе.</Typography>
          </Paper>
        ) : (
